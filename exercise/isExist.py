            ...
            class BST:
                ...
                def is_exist(self, target, start):
                    if start is None:
                        return False

                    if int(start.data) == int(target):
                        return True

                    if self.is_exist(target, start.left):
                        return True

                    if self.is_exist(target, start.right):
                        return True
            ...
            def main():
                ...
                print(my_bst.tree_height(my_bst.root))
            main()
